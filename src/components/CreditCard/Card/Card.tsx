...
const Card = () => {
	...
	const handleType = (type: string): void => {
		...
		if (cardType) setCardTypeImage(imageUrls[type]);
	};
	...
	return (
		<div className={styles.card}>
			...
			<input value={cardHolder} onChange={handleFormItem} className={styles.input} name={formItems.cardHolder.name}
						 type="text"
			...
			<div className={styles.details}>
				...
				<input value={cvv} onChange={handleFormItem} maxLength={3} type="password" name={formItems.cvv.name}
